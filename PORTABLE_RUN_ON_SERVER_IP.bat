...
call "%BORNA_PORTABLE_DEST%\PORTABLE_RUN_ON_SERVER_IP.bat"
exit /b %errorlevel%

:local_run
cd /d "%~dp0"
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0portable\bootstrap_portable_runtime.ps1" -Lan
exit /b %errorlevel%
...
echo   powershell -NoProfile -ExecutionPolicy Bypass -File portable\bootstrap_portable_runtime.ps1 -Lan
pause
exit /b 1
